...
<body> 
    ...
    <a href="<?=BASE_URL?>/Thongtingv" id="userInfo" style="display: block; padding: 10px; text-decoration: none; color: black; font-size: 14px; border-bottom: 1px solid #e0e0e0;">Thông tin người dùng</a>
        ...
        <div class="row"> 
            <div class="menu_left1"> 
                <div class="list-group"> 
                    <a href="<?=BASE_URL?>/Home/teacher" class="list-group-item "> 
                    ...
                    <span id="arrow" class="fas fa-chevron-down" style="float: right; margin-left: 10px;"></span> 
                            ...
                            <div id="submenuDetai" style="display: none; padding-left: 20px;">
                                <a href="<?=BASE_URL?>/Nhiemvu" class="list-group-item">Nhiệm Vụ</a>
                                <a href="<?=BASE_URL?>/GuithongbaoHS" class="list-group-item">Gửi Thông Báo</a>
                            </div>

                    <a href="<?=BASE_URL?>/Xemthongbaogv" class="list-group-item"> 
                    ...
                    <a href="<?=BASE_URL?>/Thongkegv" class="list-group-item">
