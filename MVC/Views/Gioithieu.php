...
<body>
    ...
    <div class="info-box">
        <img src="<?=BASE_URL?>/Public/Pictures/graduate-cap_icon-icons.com_72712.png" alt="User Icon" style="width: 50px; height: 50px; margin-left: 10px; vertical-align: middle;">
    ...
    <div class="info-box">
        <img src="<?=BASE_URL?>/Public/Pictures/videoconference_remote_work_communication_meeting_online_icon_156838.png" alt="User Icon" style="width: 50px; height: 50px; margin-left: 10px; vertical-align: middle;">
    ...
    <div class="info-box">
        <img src="<?=BASE_URL?>/Public/Pictures/compass_draft_project_plan_ruler_icon_181792.png" alt="User Icon" style="width: 50px; height: 50px; margin-left: 10px; vertical-align: middle;">
        <h3>Dự án đa dạng</h3>
...
<div class="info-boxes-row">
    <div class="info-box">
        <img src="<?=BASE_URL?>/Public/Pictures/book-open-shape_icon-icons.com_70792.png" alt="User Icon" style="width: 50px; height: 50px; margin-left: 10px; vertical-align: middle;">
        <h3>Thư viện sách</h3>
        <p>Thư viện sách miễn phí với hơn 5000 đầu sách đọc sách online, tài liệu tham khảo, đồ án miễn phí</p>
    </div>
    <div class="info-box">
        <img src="<?=BASE_URL?>/Public/Pictures/3986756-building-education-school-school-icon_112321.png" alt="User Icon" style="width: 50px; height: 50px; margin-left: 10px; vertical-align: middle;">
