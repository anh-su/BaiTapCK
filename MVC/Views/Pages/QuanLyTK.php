            ...
            <th>
                <div class="box1">
                    <div class="box1ND">
                        ...
                        <a class="s1" href="<?=BASE_URL?>/DStaikhoansv">Sinh Viên</a>
                    </div>
                </div>
            </th>
            <th>
                <div class="box1">
                    <div class="box1ND">
                        ...
                        <a class="s1" href="<?=BASE_URL?>/DStaikhoangv">Giáo Viên</a>
                    </div>
                </div>
            </th>
            <th>
                <div class="box2">
                    <div class="box1ND">
                        ...
                        <a class="s1" href="<?=BASE_URL?>/DStaikhoanad">Admin</a>
                    </div>
                </div>
            </th>
        </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="<?=BASE_URL?>/QuanlyTK/ThemmoiTKSV">
