...
<div style="margin-top: 1rem !important;" class="container mt-5">
    ...
    <form id="formThongbao" action="<?=BASE_URL?>/GuithongbaoHS/saveThongbao" method="POST">
        <hr class="custom-hr">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" method="POST" action="<?=BASE_URL?>/GuithongbaoHS/suaThongbao">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="deleteForm" action="<?=BASE_URL?>/GuithongbaoHS/xoaThongbao" method="POST">
                <div class="modal-header">
...
<script>
    $(document).ready(function() {
        ...
        $('#deleteForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?=BASE_URL?>/GuithongbaoHS/xoaThongbao/' + id,
                type: 'POST',
        ...
        $('#confirmResetButton').click(function() {
            $.ajax({
                url: '<?=BASE_URL?>/GuithongbaoHS/resetThongbao',
                type: 'POST',
                success: function(response) {
