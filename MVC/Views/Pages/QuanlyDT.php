...
<body>
    ...
    <div class="container">
        ...
        <a href="<?=BASE_URL?>/DSdetai" class="edit-link">
            <==Quản Lý Đề Tài</a>
                <hr class="custom-hr">
                <form id="registrationForm" method="post" action="<?=BASE_URL?>/QuanlyDT/themmoi"
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" method="post" action="<?=BASE_URL?>/QuanlyDT/sua">
                        <div class="form-row">
    ...
    <form id="deleteForm" method="post" action="<?=BASE_URL?>/QuanlyDT/xoa">
