...
<body>
  ...
  <div class="form-container">
    <form method="post" action="<?=BASE_URL?>/QuanlyTK/themmoi">
      <div class="form-row">
  ...
  <form method="post" action="<?=BASE_URL?>/QuanlyTK/timkiem">
    <br>
    <hr class="custom-hr">
        ...
        <?php if (!empty($data['danhSachTaiKhoansv'])) :
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?=BASE_URL?>/QuanlyTK/xoa/<?php echo$QuanlyTK['ID_TK'] ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="<?=BASE_URL?>/QuanlyTK/capnhat">
