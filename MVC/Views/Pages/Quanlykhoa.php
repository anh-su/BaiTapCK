...
<body>
    ...
    <div class="form-container">
        <form method="post" action="<?=BASE_URL?>/Quanlykhoa/themmoi">
            <div class="form-row">
    ...
    <form method="post" action="<?=BASE_URL?>/Quanlykhoa/timkiem">
        <br>
        <hr class="custom-hr">
                    ...
                    <?php foreach ($data['danhsachkhoa'] as $Quanlykhoa): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?=BASE_URL?>/Quanlykhoa/xoakhoa/<?php echo $Quanlykhoa['ID_Khoa'] ?>">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="<?=BASE_URL?>/Quanlykhoa/capnhatkhoa">
