...
<form method="post" action="<?=BASE_URL?>/Sinhvien/themmoi">
   ...
   <img src="<?=BASE_URL?>/Public/Pictures/edit.gif" alt="Edit">
                                    ...
                                    <a href="<?=BASE_URL?>/Sinhvien/deleteSinhvien/<?php echo $row['ID_Sinhvien']; ?>">
    ...
    <div class="modal-dialog" role="document" style="max-width: 800px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?=BASE_URL?>/Sinhvien/capnhatsv" id="editStudentForm">
                    <div class="form-row">
