...
<body>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?=BASE_URL?>/Nhiemvu/Update_grade_details">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-detail').on('click', function () {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/Nhiemvu/Get_group_details',
                    type: 'POST',
                    data: { ID_DTSV: idDTSV },
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/Nhiemvu/Get_grade_details',
                    type: 'POST',
                    data: { ID_DTSV: idDTSV },
                    success: function (response) {
            ...
            $('#viewReport, #editViewReport').on('click', function () {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/Nhiemvu/Get_report_file',
                    type: 'POST',
                    data: { ID_DTSV: idDTSV },
                    success: function (response) {
                        var data = JSON.parse(response);
            ...
            $('#gradeButton').on('click', function () {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/Nhiemvu/Grade_group',
                    type: 'POST',
                    data: {
                        ID_DTSV: idDTSV,
                        score: score,
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            ...
                            $.ajax({
                                url: '<?=BASE_URL?>/Nhiemvu/Update_status',
                                type: 'POST',
    ...
    // $('#formContainer').load(location.href + ' #formContainer');  // Làm mới một phần cụ thể của trang
            ...
            $('#editViewReport').on('click', function () {
                var idDTSV = $(this).data('id');
                var reportUrl = '<?=BASE_URL?>/Nhiemvu/View_report?ID_DTSV=' + idDTSV;
            ...
            $('#updateButton').on('click', function () {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/Nhiemvu/Update_grade_details',
                    type: 'POST',
                    data: {
                        ID_DTSV: idDTSV,
                        score: score,
            ...
            $('.btn-complete').on('click', function () {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/Nhiemvu/Complete_task',
                    type: 'POST',
                    data: { ID_DTSV: idDTSV },
                    success: function (response) {
                        if (response.status === 'success') {
