    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.btn-status').on('click', function () {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/ChitietDT/Get_grade_details',
                    type: 'POST',
                    data: { ID_DTSV: idDTSV },
            ...
            $('.btn-detail').on('click', function () {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/DSdetai/Get_member_details',
                    type: 'POST',
                    data: { ID_DTSV: idDTSV },
                    success: function (response) {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/ChitietDT/Get_detail',
                    type: 'POST',
                    data: { ID_DTSV: idDTSV },
                    success: function (response) {
                        var data = JSON.parse(response);
            ...
            $('#editModal').on('show.bs.modal', function (event) {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/ChitietDT/Get_detaisinhvien_details',
                    type: 'POST',
                    data: { ID_DTSV: idDTSV },
                    success: function (response) {
            ...
            $('.btn-reject').on('click', function () {
                ...
                $('#confirmRejectButton').on('click', function () {
                    $.ajax({
                        url: '<?=BASE_URL?>/ChitietDT/rejectDetai',  // URL xử lý cập nhật
                        type: 'POST',
                        data: {
                            ID_DTSV: idDTSV,
            ...
            $('#addMemberButton').on('click', function () {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/ChitietDT/addMember',
                    type: 'POST',
                    data: formData,
                    success: function (response) {
                        if (response.status === 'success') {
            ...
            $('#uploadForm').submit(function (event) {
                ...
                $.ajax({
                    url: '<?=BASE_URL?>/ChitietDT/UploadFileBaoCao',  // Đường dẫn đến hàm UploadFileBaoCao()
                    type: 'POST',
                    data: formData,
