...
<body>
  ...
  <div class="form-container">
    <form method="post" action="<?=BASE_URL?>/DStaikhoanad/themmoi">
      <div class="form-row">
  ...
  <form method="post" action="<?=BASE_URL?>/DStaikhoanad/timkiemad">
    <br>
    <hr class="custom-hr">
        ...
        <?php if (!empty($data['danhSachTaiKhoanad'])) : 
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?=BASE_URL?>/DStaikhoanad/xoaad/<?php echo $DStaikhoanad['ID_TK'] ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="<?=BASE_URL?>/DStaikhoand/capnhatgad">
