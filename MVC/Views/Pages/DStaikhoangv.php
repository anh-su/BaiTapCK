...
<body>
  ...
  <div class="form-container">
    <form method="post" action="<?=BASE_URL?>/DStaikhoangv/themmoi">
      <div class="form-row">
  ...
  <form method="post" action="<?=BASE_URL?>/DStaikhoangv/timkiemgv">
    <br>
    <hr class="custom-hr">
        ...
        <?php if (!empty($data['danhSachTaiKhoangv'])) : 
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?=BASE_URL?>/DStaikhoangv/xoagv/<?php echo $DStaikhoangv['ID_TK'] ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="<?=BASE_URL?>/DStaikhoangv/capnhatgv">
